          ...
          <div class="col-xl">
            <div class="card mb-4">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end">Edit Category {{ $mainCategory->name }}</small>
              </div>
              <div class="card-body">
                <form method="POST" action="{{ route("admin.categories.update", $mainCategory->slug) }}" enctype="multipart/form-data">
                  @csrf
                  @method("PATCH")
                    ...
                    <div class="mb-3">
                      ...
                      <div class="input-group input-group-merge">
                          ...
                          <input
                              ...
                              aria-label="John Doe"
                              autofocus
                              value="{{ old($locale . '.name', $mainCategory->translate($locale)->name) }}"
                  ...
                  <div class="mb-3">
                    <div class="form-check">
                      <input
                        ...
                        value="active"
                        id="active"
                        {{ $mainCategory->status == "active" ? "checked" : "" }}
                      />
                    ...
                    <div class="form-check">
                      <input
                        ...
                        value="inactive"
                        id="inactive"
                        {{ $mainCategory->status == "inactive" ? "checked" : "" }}
                      />
