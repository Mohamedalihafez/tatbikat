...
<x-layouts.back-end.application>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Brands/</span> Publish New Brand</h4>
          ...
          <div class="col-xl">
            <div class="card mb-4">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Publish New Brand</h5>
                <small class="text-muted float-end">Publish New Brand</small>
              </div>
              <div class="card-body">
                <form method="POST" action="{{ route("admin.brands.store") }}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
