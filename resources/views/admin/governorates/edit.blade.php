        ...
        <div class="row">
          <div class="col-xl">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route("admin.governorates.update", $governorate->slug) }}" autocomplete="off">
                    @csrf
                    @method("PATCH")
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input
                                ...
                                aria-label="John Doe"
                                autofocus
                                value="{{ old($locale . '.name', $governorate->translate($locale)->name) }}"
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input
                            ...
                            name="slug"
                            value="{{ old("slug", $governorate->slug) }}"
                  ...
                  <div class="mb-3">
                    <div class="form-check">
                      <input
                        ...
                        value="active"
                        id="active"
                        {{ $governorate->status == "active" ? "checked" : "" }}
                      />
                    ...
                    <div class="form-check">
                      <input
                        ...
                        value="inactive"
                        id="inactive"
                        {{ $governorate->status == "inactive" ? "checked" : "" }}
                      />
